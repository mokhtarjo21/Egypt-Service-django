...
class User(AbstractUser):
    ...
    idPhotoUrl = models.ImageField(upload_to='users/', null=True, blank=True, default='id_default.jpg')
    idfPhotoUrl = models.ImageField(upload_to='users/', null=True, blank=True, default='id_front_default.jpg')
    iduserPhotoUrl = models.ImageField(upload_to='users/', null=True, blank=True, default='id_user_default.jpg')
